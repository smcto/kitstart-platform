            ...
            <div className="rounded-2xl border border-slate-200/70 bg-white overflow-hidden">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap items-center gap-1.5 mt-0.5">
                          <span className={cn("flex items-center gap-0.5 rounded px-1 py-0.5 text-[9px] font-bold", pr.bg, pr.color)}>
                          ...
                          {assignee && (
                            <img src={assignee.photo} alt={assignee.name} className="h-3.5 w-3.5 rounded-full object-cover" title={assignee.name} />
                          )}
                        </div>
                      </div>
                      <button
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-end gap-1.5">
                      <button
                        ...
                        className="rounded-md px-2 py-1 text-[11px] font-medium text-[--k-muted] hover:bg-[--k-surface-2] transition"
                      >
                        Annuler
                      </button>
                      <button
              ...
              {todos.length === 0 && !addingTodo && (
                <div className="px-4 py-6 text-center">
                  ...
                  <p className="text-[12px] text-[--k-muted]">Aucune tâche</p>
                  <button
                    onClick={() => setAddingTodo(true)}
                    className="mt-1.5 text-[11px] font-semibold text-[--k-primary] hover:underline"
                  >
