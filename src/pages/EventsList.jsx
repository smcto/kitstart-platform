...
const EVENTS = [
  { id: "EVT-2026-0287", name: "Salon du Mariage Paris", client: "Salon Expo SAS", dateStart: "2026-02-08", dateEnd: "2026-02-10", bornes: 12, type: "Salon", location: "Paris Expo — Porte de Versailles", status: "ready", antenne: "IDF Paris", ca: "18 500 €", contact: "Marie Laurent" },
  { id: "EVT-2026-0291", name: "Soirée L'Oréal 50 ans", client: "L'Oréal Group", dateStart: "2026-02-10", dateEnd: "2026-02-10", bornes: 4, type: "Corporate", location: "Pavillon Cambon, Paris", status: "logistics", antenne: "IDF Paris", ca: "8 200 €", contact: "Thomas Duval" },
  { id: "EVT-2026-0294", name: "Mariage Dupont-Martin", client: "Famille Dupont", dateStart: "2026-02-14", dateEnd: "2026-02-14", bornes: 2, type: "Mariage", location: "Château de Versailles", status: "design", antenne: "IDF Paris", ca: "3 400 €", contact: "Julie Dupont" },
  { id: "EVT-2026-0298", name: "Festival Nantes Digital", client: "Nantes Métropole", dateStart: "2026-02-15", dateEnd: "2026-02-17", bornes: 8, type: "Festival", location: "Parc des Expo, Nantes", status: "confirmed", antenne: "Grand Ouest", ca: "14 200 €", contact: "Pierre Morin" },
  { id: "EVT-2026-0302", name: "Team Building Airbus", client: "Airbus SE", dateStart: "2026-02-18", dateEnd: "2026-02-18", bornes: 3, type: "Corporate", location: "Blagnac, Toulouse", status: "design", antenne: "Occitanie", ca: "5 100 €", contact: "Sophie Bernard" },
  { id: "EVT-2026-0305", name: "Gala BMW Munich", client: "BMW AG", dateStart: "2026-02-20", dateEnd: "2026-02-20", bornes: 6, type: "Corporate", location: "BMW Welt, Munich", status: "confirmed", antenne: "International", ca: "12 800 €", contact: "Hans Weber" },
  { id: "EVT-2026-0308", name: "Mariage Cohen-Lévy", client: "Famille Cohen", dateStart: "2026-02-22", dateEnd: "2026-02-22", bornes: 2, type: "Mariage", location: "Domaine de Primard", status: "prospect", antenne: "IDF Paris", ca: "3 200 €", contact: "Rachel Cohen" },
  { id: "EVT-2026-0312", name: "Salon Auto Lyon", client: "Lyon Auto Events", dateStart: "2026-02-25", dateEnd: "2026-02-27", bornes: 10, type: "Salon", location: "Eurexpo Lyon", status: "prospect", antenne: "Rhône-Alpes", ca: "16 800 €", contact: "Marc Petit" },
  { id: "EVT-2026-0315", name: "Anniversaire Nike", client: "Nike France", dateStart: "2026-02-28", dateEnd: "2026-02-28", bornes: 5, type: "Corporate", location: "Nike Campus, Paris", status: "prospect", antenne: "IDF Paris", ca: "9 400 €", contact: "Léa Martin" },
  { id: "EVT-2026-0256", name: "Soirée Chanel N°5", client: "Chanel SAS", dateStart: "2026-01-28", dateEnd: "2026-01-28", bornes: 3, type: "Corporate", location: "Grand Palais, Paris", status: "invoiced", antenne: "IDF Paris", ca: "7 600 €", contact: "Emma Blanc" },
  { id: "EVT-2026-0248", name: "Carnaval Nice", client: "Ville de Nice", dateStart: "2026-01-24", dateEnd: "2026-01-26", bornes: 15, type: "Festival", location: "Promenade des Anglais", status: "done", antenne: "PACA", ca: "22 400 €", contact: "Antoine Rossi" },
  { id: "EVT-2026-0241", name: "Mariage Petit-Grand", client: "Famille Petit", dateStart: "2026-01-18", dateEnd: "2026-01-18", bornes: 1, type: "Mariage", location: "Moulin de Vernègues", status: "invoiced", antenne: "PACA", ca: "1 800 €", contact: "Claire Petit" },
];
...
const STATUS_MAP = {
  ...
  invoiced: { label: "Facturé", color: "bg-green-50 text-green-600", dot: "bg-green-600" },
};
...
export default function EventsList() {
  ...
  const filtered = EVENTS.filter(e => {
    ...
    if (tab === "active") return !["done", "invoiced", "prospect"].includes(e.status);
    if (tab === "prospect") return e.status === "prospect";
    if (tab === "done") return ["done", "invoiced"].includes(e.status);
    return true;
  });
    ...
    <AppShell currentApp="Events Manager" activeKey="events-list">
      ...
      <div className="rounded-2xl border border-[--k-border] bg-white shadow-sm">
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="border-b border-[--k-border] bg-rose-50/20">
                ...
                <th className="px-4 py-2.5 text-right font-semibold text-[--k-muted]">CA</th>
              ...
              {filtered.map(evt => {
                ...
                return (
                  <tr key={evt.id} className="border-b border-[--k-border] last:border-0 hover:bg-[--k-surface-2]/30 transition group">
                    ...
                    <td className="px-4 py-2.5 text-right font-semibold text-[--k-text] whitespace-nowrap">{evt.ca}</td>
        ...
        <div className="flex items-center justify-between border-t border-[--k-border] px-4 py-2.5 text-[12px] text-[--k-muted]">
          ...
          <span>CA total: <strong className="text-[--k-text]">123 500 €</strong></span>
        </div>
      </div>
    </AppShell>
  );
